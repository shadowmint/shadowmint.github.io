...
var log = cherub.utils.logger.get();
/// <reference path="__init__.ts"/>
/// <reference path="__init__.ts"/>
var cherub;
(function (cherub) {
            ...
            var Master = (function () {
                ...
                Master.prototype.add = function (target) {
                    if (target) {
                        ...
                        if (this._validateWidget(widget)) {
                            ...
                            log.warn('Drawable ' + target + ' has no valid widgets');
                        }
                    }
                };
                ...
                Master.prototype._validateWidget = function (target) {
                    ...
                    if (!target) {
                        ...
                        log.info('Valid widget: ' + target.toString());
                ...
                Base.prototype.validate = function (assets) {
                    ...
                    for (var key in assets) {
                        if (!cherub.utils.assets.validate(assets[key])) {
                            log.warn('Missing asset: ' + assets[key]);
                            rtn = false;
                        }
                    }
                    return rtn;
        ...
        (function (core) {
            ...
            */
            var Scene = (function () {
                ...
                * Override this methid in subclasses.
                */
        ...
        (function (objects) {
            ...
            var Block = (function (_super) {
                ...
                Block.prototype.changed = function () {
                    ...
                    if ((widget.width != this._lstate[0]) || (widget.height != this._lstate[1])) {
                        this._lstate = [widget.width, widget.height];
                        return true;
                    }
                    return false;
                };
                ...
                Block.prototype.update = function (dt, master) {
                    if (this.step(dt, 200)) {
                        if (this.changed()) {
                            var xmin = -this.container.width / 2;
                            var xmax = this.container.width / 2;
                            var ymin = -this.container.height / 2;
                            var ymax = this.container.height / 2;
